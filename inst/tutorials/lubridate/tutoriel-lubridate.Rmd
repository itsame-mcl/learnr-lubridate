...
A cela s'ajoute deux autres options : `week_start` et `locale` qui peuvent être utilisées dans le cas de dates internationales (conversion entre différents systèmes de dates). L'option `week_start` défini le début de la semaine. Par convention, 1 correspond à lundi et 7 correspond à dimanche. Quant à `locale`, il s'agit de définir les noms des jours ou mois (en fonction de la langue).
...
quiz(
  question("Nous avons décidé d'arrondir la date `1999-09-01 11:59:50 UTC` et nous obtenons `2000-01-01 UTC`. Quelles commandes permettent ce résultat ?",
    ...
    answer('round_date(exemple_date, unit = "month")',
           message = "On veut arrondir la date à l'année supérieure."),
    ...
    random_answer_order = TRUE, 
    try_again_button = "Recommencer", 
    incorrect = "Deux commandes permettent d'obtenir ce résultat.", 
    submit_button = "Soumettre la réponse", 
    correct = "Bonne réponse !"
  ),
