...
A cela s'ajoute deux autres options : `week_start` et `locale` qui sont peu utilisées. L'option `week_start` défini le début de la semaine. Par convention, 1 correspond à lundi et 7 correspond à dimanche. Quant à `locale`, il s'agit de définir les noms des jours ou mois (en fonction de la langue).
